...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('fontend/assets/vendor/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('fontend/assets/vendor/icofont/icofont.min.css') }}">
    <link rel="stylesheet" href="{{ asset('fontend/assets/vendor/boxicons/css/boxicons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('fontend/assets/vendor/animate.css/animate.min.css') }}">
    <link rel="stylesheet" href="{{ asset('fontend/assets/vendor/venobox/venobox.css') }}">
    <link rel="stylesheet" href="{{ asset('fontend/assets/vendor/owl.carousel/assets/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('fontend/assets/vendor/aos/aos.css') }}">
    <link rel="stylesheet" href="{{ asset('fontend/assets/vendor/remixicon/remixicon.css') }}">
